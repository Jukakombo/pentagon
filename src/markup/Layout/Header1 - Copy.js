...
class Header1 extends Component {
  componentDidMount() {
    ...
    var navUl = [].slice.call(
      document.querySelectorAll('.navbar-nav > li > a')
    );
    ...
    // Sidenav li open close
    var navUl2 = [].slice.call(
      document.querySelectorAll('.navbar-nav > li > .sub-menu > li > a')
    );
    for (var y2 = 0; y2 < navUl2.length; y2++) {
      navUl2[y2].addEventListener('click', function () {
        checkLi2(this);
      });
    }
            ...
            <div className="container">
              <div className="row d-flex justify-content-between">
                <div className="dlab-topbar-left">
                  <ul>
                    <li>
                      <i className="flaticon-phone-call m-r5"></i> +001 1234
                      6789
                    </li>
                    <li>
                  ...
                  <ul className="nav navbar-nav">
                    ...
                    <li>
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <Link to={''}>
                            Coming Soon <i className="fa fa-angle-right"></i>
                          </Link>
                          <ul className="sub-menu">
                            <li>
                              <Link to={'./coming-soon-1'} className="dez-page">
                                Coming Soon 1{' '}
                              </Link>
                            </li>
                          </ul>
